  ...
  return (
    <div className="h-full flex flex-col overflow-hidden bg-background">
      ...
      <div className="flex-1 min-h-0 flex">
        {/* ─── COLUMN A: Chart (~65%) ─── */}
        <div className="flex-[9] min-w-0 flex flex-col border-r border-border-default">
        ...
        <div className="flex-[5] min-w-0 flex flex-col border-r border-border-default bg-surface/10">
          {/* Tab switcher */}
        ...
        <div className="flex-[5] min-w-0 flex flex-col overflow-y-auto scrollbar-none">
