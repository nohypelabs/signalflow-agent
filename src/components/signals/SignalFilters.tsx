...
export default function SignalFilters({
  ...
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 mb-5">
      ...
      {/* Type filter */}
      <div className="flex items-center gap-1 bg-inset border border-border-default rounded-lg p-0.5">
        {typeOptions.map((opt) => {
      ...
      <select
        ...
        className="bg-inset border border-border-default rounded-lg px-2.5 py-1.5 text-[10px] text-txt-secondary focus:outline-none focus:border-accent-dim cursor-pointer"
      >
